...
function Header() {
  ...
  const { user, setUser, items } = useContext(Context);
  ...
  return (
    <header id="main-header">
      <div className="title" onClick={() => navigate("/meals")} style={{ cursor: "pointer" }}>
        <img src="https://res.cloudinary.com/dfypghcgt/image/upload/v1779007561/logo_wzqpze.jpg" alt="Website Logo" />
        <h1>TastyBite</h1>
      </div>
      <div className="header-actions">
        {user && (
          <button className="cart-header-btn" onClick={() => navigate("/cart")}>
